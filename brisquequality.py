...
def cv_show(img, title="Example Image"):
    # 显示图片
...
# 创建一个新的工作簿
wb = xlsxwriter.Workbook('BRISQUE_ALGORITHM.xlsx')
...
for root, dirs, files in os.walk(folder_path):
    for i, file in enumerate(files):
        ...
        ws.insert_image(i + 1, 2, file_path, {'x_scale': 0.05, 'y_scale': 0.05})

# 保存excel文件
wb.close()

# calculate quality score
# qualityscore = test_measure_BRISQUE('E:\\HSR\\IQA\\17\\000918862_K1915613_22_5_17.jpg')
